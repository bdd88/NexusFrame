<?php
namespace Bdd88\RestApi\Api\Rest\Controller;
...
class Main
{
    ...
    public function __construct(?string $publicKey = NULL, ?string $privateKey = NULL, private ?bool $debugMode = NULL)
    {
        ...
        $this->serviceContainer->create('\NexusFrame\Token\Jwt\JwtFactory', [$publicKey, $privateKey]);
    ...
    public function createToken(array $header, array $payload): string
    {
        ...
        $jwtFactory = $this->serviceContainer->get('\NexusFrame\Token\Jwt\JwtFactory');
